    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="container mx-auto p-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-slate-200">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-slate-200">
                <thead>
                  <tr>
                    <th className="px-4 py-2 text-left text-xs font-semibold text-slate-600 uppercase">Workflow ID</th>
                    <th className="px-4 py-2 text-left text-xs font-semibold text-slate-600 uppercase">Decision</th>
                    <th className="px-4 py-2 text-left text-xs font-semibold text-slate-600 uppercase">Time</th>
                  </tr>
                </thead>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-slate-200">
            ...
            <div className="space-y-4">
              {stats?.alerts?.length > 0 ? (
                ...
                <p className="text-slate-600 italic">No critical alerts at this time.</p>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
          <div className="bg-white p-6 rounded-lg shadow-sm border border-slate-200">
            <h2 className="text-xl font-semibold mb-2 text-gray-900">Rule Management</h2>
            <p className="text-slate-700">Manage and version compliance rules.</p>
            <a href="/rules" className="mt-4 inline-block text-indigo-600 font-semibold hover:underline">View Rules →</a>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-sm border border-slate-200">
            <h2 className="text-xl font-semibold mb-2 text-gray-900">Metrics</h2>
            <p className="text-slate-700">System health and AI performance.</p>
            <a href="/metrics" className="mt-4 inline-block text-indigo-600 font-semibold hover:underline">View Metrics →</a>
          </div>
        </div>
      </main>
    </div>
